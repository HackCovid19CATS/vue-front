    ...
    <div class="box">
        ...
        <div class="detail box" :class="{ visible: showDetail }">
            ...
            <div class="inventory">
                ...
                <Empty class="inventory-status"  :class="{ visible: showDetail && inventoryStatus === 'empty' }"/>
                <PartlyFilled class="inventory-status"  :class="{ visible: showDetail && inventoryStatus === 'partly-filled' }"/>
                <WellFilled class="inventory-status"  :class="{ visible: showDetail && inventoryStatus === 'well-filled' }"/>
            </div>
            <div class="rules">
